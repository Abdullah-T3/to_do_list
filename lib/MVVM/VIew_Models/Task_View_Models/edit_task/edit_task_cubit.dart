...
class EditTaskCubit extends Cubit<EditTaskState> {
  ...
  Future<void> fetchTask( ) async {
    ...
    try {
      ...
      final task = (response as List<dynamic>).map((item) => TaskModel.fromJson(item)).first;
      ...
      print('isDone: $isDone, title: ${task.title}, content: ${task.taskContent}, startDate: ${task.startDate}, endDate: ${task.endDate}, repeat: ${task.repeat}, place: ${task.place}, reminder: ${task.reminder}');
