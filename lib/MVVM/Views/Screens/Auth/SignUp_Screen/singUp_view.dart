              ...
              child: Padding(
                ...
                child: BlocConsumer<AuthCubit, AuthState>(listener: (context, state) {
                  ...
                  return Column(
                    ...
                    children: [
                      Text("Task Manager", style: TextStyle(fontSize: deviceinfo.screenWidth * 0.1, fontWeight: FontWeight.bold, color: Colors.white)),
                      ...
                      Container(
                        ...
                        child: MaterialButton(
                          ...
                          child: state is AuthLoading ? CircularProgressIndicator(color: Colors.white) : Text("Sign Up", style: TextStyle(color: Colors.white, fontSize: deviceinfo.screenWidth * 0.04, fontWeight: FontWeight.bold)),
                        ),
                      ),
                      RichText(
                        text: TextSpan(
